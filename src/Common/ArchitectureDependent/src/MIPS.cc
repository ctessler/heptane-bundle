...
#define DEFAULT_VALUE_LATENCY_LOAD 100
#define DEFAULT_VALUE_LATENCY_STORE 100
...
MIPS::MIPS(const bool is_big_endian_p)
{
  ...
  // Store
  mnemonicToInstructionTypes["sw"] = new Store(4, "alu", formats["rs_mem"], new Nop(), DEFAULT_VALUE_LATENCY_STORE);
  ...
  mnemonicToInstructionTypes["swc1"] = new Store(4, "alu", formats["rs_mem"], new Nop(),DEFAULT_VALUE_LATENCY_STORE);
  mnemonicToInstructionTypes["sh"] = new Store(2, "alu", formats["rs_mem"], new Nop(), DEFAULT_VALUE_LATENCY_STORE);
  mnemonicToInstructionTypes["sb"] = new Store(1, "alu", formats["rs_mem"], new Nop(), DEFAULT_VALUE_LATENCY_STORE);
  mnemonicToInstructionTypes["sdc1"] = new Store(8, "alu", formats["rs_mem"], new Nop(), DEFAULT_VALUE_LATENCY_STORE);
  ...
  mnemonicToInstructionTypes["sll"] = new Basic("alu", formats["rd_rs_hex"], new KillOp1(), DEFAULT_VALUE_LATENCY);
...
bool MIPS::isBinaryAsmCode(const string& str)
{
...
bool MIPS::getInstr2ARMInfos(string & instr, string & codeinstr, string & oregister, offsetType * TypeOperand, string & operand1, string & operand2,
			     string & operand3)
{
  assert(false);
  return false;
